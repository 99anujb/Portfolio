        ...
        <div className="contact-flex">
          <div className="contact-box">
            ...
            <p className="availability-note">
              <span className="availability-dot" aria-hidden="true" /> Open to
              Data Analyst, Business Analyst, and Data Scientist roles —
          ...
          <div className="contact-box">
            ...
            <a
              href="https://public.tableau.com/app/profile/anuj.bansal4965"
              target="_blank"
              rel="noreferrer"
              data-cursor="disable"
              className="contact-social"
            >
              Tableau Public <MdArrowOutward />
            </a>
            <a
